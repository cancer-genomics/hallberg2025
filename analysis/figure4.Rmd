---
title: "Figure 4 tiles of integrated data"
...
tiles <- expand.grid(lab_id=levels(idat2$lab_id),
    ...
    drop_na()
id <- filter(tiles, gene_symbol=="ERBB2",
...
cutoffs2 <- bind_rows(cutoffs, cutoffs) %>%
    mutate(tumor_type=factor(tumor_type, tumor.levels))
cutoffs2$tumor_type[3:4] <- "Colorectal mucinous"
